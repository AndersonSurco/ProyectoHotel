                    ...
                    >
                      ...
                      <tbody>
                        ...
                        <form action="ControlReserva" method="Post">
                          <td><input type="text" name="cod" class="form-control" size="5"  value='<%= f[0] %>'/></td>
                          <td><input type="text" name="tip" class="form-control" size="10" value='<%= f[1] %>'/></td>
                          <td><input type="text" name="est" class="form-control" size="10"  value='<%= f[2] %>'/></td>
                          <td><input type="text" name="pre" class="form-control" size="5"  value='<%= f[3] %>'/></td>
                          <td><input type="text" name="fecIni" data-provide="datepicker" class="form-control date" size="5" value="" required/></td>
                          <td><input type="text" name="fecFin" class="form-control" size="5" value="" required/></td>
                          <td><input type="submit" name="acc"  class="btn btn-primary btn-block" value="Agregar"/></td>
                        </form>
                        </tr> 
                        <% } %>
                      </tbody>
